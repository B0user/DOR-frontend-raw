...
import GrantUploadPage from "./pages/GrantUploadPage";
import ScholarshipUploadPage from "./pages/ScholashipUploadPage";
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route element={<PersistLogin />}>
              <Route element={<RequireAuth allowedRoles={['dor']}/>}>
                ...
                <Route path="grants">
                  <Route index element={<Temp />} />
                  <Route path="upload" element={<GrantUploadPage />} />
                  <Route path=":id" element={<GrantUploadPage />} />
                </Route>

                <Route path="scholarships">
                  <Route index element={<Temp />} />
                  <Route path="upload" element={<ScholarshipUploadPage />} />
                  <Route path=":id" element={<ScholarshipUploadPage />} />
                </Route>
              </Route>
            </Route>
